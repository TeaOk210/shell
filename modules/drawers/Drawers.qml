    ...
    model: Quickshell.screens
        ...
        StyledWindow {
            ...
            WlrLayershell.keyboardFocus: ((visibilities.launcher && Config.launcher.enabled)
                ...
                || (visibilities.dashboardLock && Config.dashboard.enabled)) ? WlrKeyboardFocus.OnDemand : WlrKeyboardFocus.None
